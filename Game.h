...
class Game{
    public:
       ...
       int getChainIndex(Player& player){
               ...
               cout << player.getName() <<" vous avez "<<player.getNumChains()<<endl;
       ...
       int getChoice(){
           int choice;
           cout<<"Voulez-vous "<<
           endl<<"1.Essayez encore "
           <<endl<<"2.Rompre l'action "<<endl
           <<"Entrez votre choix ici : ";
           cin>>choice;
           if(choice!=1 && choice!=2){
       ...
       int getDiscardChoice(string diff){
           ...
           cout<<"Voulez-vous "<<
           endl<<"1."<<diff
           <<endl<<"2.Discard une chaine  "<<endl
           <<"Entrez votre choix ici : ";
           cin>>choice;
           if(choice!=1 && choice!=2){
             cout<<"SVP entrez un choix valide ";
       ...
       int getTradeLength(Player& player){
           ...
           if(choice>player.getSizePlayer()&&choice<=0){
             cout<<"SVP entrez un nombre valide >0 et <"<<player.getSizePlayer()<<endl;
       ...
       string getCardPlayer(Player& player){
           ...
           if(player.getCardByName(choice)==nullptr){
             cout<<"SVP entre une carte qui se trouve dans votre main "<<endl;
